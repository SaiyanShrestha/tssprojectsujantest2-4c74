[tssprojectsujantest2-4c74] Details
============================
...
.. list-table::
   ...
   * - jsoncriteria
     - uid=hostName,filter:a;;records~subtopics=hostName,hostName,hostName~values=inboundpackets,outboundpackets,pingStatus~identifiers=inboundpackets,outboundpackets,pingStatus~datetime=lastUpdated~msgid=~latlong=
