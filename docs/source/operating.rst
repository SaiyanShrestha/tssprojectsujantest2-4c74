...
Generated On: 2024-11-09 02:44:52 UTC
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/SaiyanShrestha/rashpberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39145  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='saiyanshrestha'  \-\-env DOCKERUSERNAME='saiyanshrestha'  \-\-env MQTTUSERNAME='saiyanshrestha'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   docker run -d -p 33039:33039 -p 40219:40219 -p 36105:36105 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=tssprojectsujantest2-4c74 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-tssprojectsujantest2-4c74 \-\-env GITUSERNAME=saiyanshrestha  \-\-env GITREPOURL=https://github.com/SaiyanShrestha/rashpberrypi \-\-env SOLUTIONEXTERNALPORT=33039  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=40219  \-\-env SOLUTIONVIPERVIZPORT=36105 \-\-env DOCKERUSERNAME='saiyanshrestha' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=39145 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='saiyanshrestha' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  saiyanshrestha/tssprojectsujantest2-4c74-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=36105
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=33039
...
It can be accessed by entering: http://localhost:40219
...
.. important::
   http://localhost:36105/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:36105/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:36105/<html file>
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=33039, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44159, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42317, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=38827, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38385, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40895, HPDEHOST=127.0.1.1, HPDEPORT=41869, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36027

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7145-tssprojectsujantest2-4c74,solution_preprocessing_ai_mqtt_dag-tssprojectsujantest2-4c74, python-preprocess-3330-tssprojectsujantest2-4c74,solution_preprocessing_ai_mqtt_dag-tssprojectsujantest2-4c74, python-ai-8735-tssprojectsujantest2-4c74,solution_preprocessing_ai_mqtt_dag-tssprojectsujantest2-4c74, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
