[tssprojectsujantest2-4c74] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tssprojectsujantest2-4c74] container is NOT running**.

.. tip::
   You must have your [tssprojectsujantest2-4c74] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/SaiyanShrestha/rashpberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40099  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='saiyanshrestha'  \-\-env DOCKERUSERNAME='saiyanshrestha'  \-\-env MQTTUSERNAME='saiyanshrestha'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   saiyanshrestha/tssprojectsujantest2-4c74-amd64 (https://hub.docker.com/r/saiyanshrestha/tssprojectsujantest2-4c74-amd64)
...
.. important::
   docker run -d -p 51297:51297 -p 38555:38555 -p 54697:54697 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=tssprojectsujantest2-4c74 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-tssprojectsujantest2-4c74 \-\-env GITUSERNAME=saiyanshrestha  \-\-env GITREPOURL=https://github.com/SaiyanShrestha/rashpberrypi \-\-env SOLUTIONEXTERNALPORT=51297  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=38555  \-\-env SOLUTIONVIPERVIZPORT=54697 \-\-env DOCKERUSERNAME='saiyanshrestha' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=40099 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='saiyanshrestha' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  saiyanshrestha/tssprojectsujantest2-4c74-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=54697
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=51297
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - saiyanshrestha/tssprojectsujantest2-4c74-amd64
...
It can be accessed by entering: http://localhost:38555
...
.. important::
   http://localhost:54697/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:54697/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:54697/<html file>
...
[tssprojectsujantest2-4c74] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/saiyanshrestha/rashpberrypi/tree/main/tml-airflow/dags/tml-solutions/tssprojectsujantest2-4c74
...
.. important::
   https://tssprojectsujantest2-4c74.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-tssprojectsujantest2-4c74
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=51297, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43733, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33357, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35085, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=40455, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37515, HPDEHOST=127.0.1.1, HPDEPORT=36729, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33759

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8793-tssprojectsujantest2-4c74,solution_preprocessing_ai_mqtt_dag-tssprojectsujantest2-4c74, python-preprocess-1526-tssprojectsujantest2-4c74,solution_preprocessing_ai_mqtt_dag-tssprojectsujantest2-4c74, python-ai-5932-tssprojectsujantest2-4c74,solution_preprocessing_ai_mqtt_dag-tssprojectsujantest2-4c74, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
